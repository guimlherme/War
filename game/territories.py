...
class Board:
    ...
    def initiate_territories(self):
        ...
        self.continents = {"north_america": north_america, 
        ...
        return north_america + south_america + europe + africa + asia + oceania

    def verify_conquered_continents(self, player):
    ...
    def continent_to_troops(self, continent):
        if set(self.continents["north_america"]) == set(continent):
            return 5
        if set(self.continents["south_america"]) == set(continent):
            return 2
        ...
        if set(self.continents["oceania"]) == set(continent):
            return 2
        raise ValueError("Something went wrong in continent checking")
